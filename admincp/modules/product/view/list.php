...
<div class="box"> <!-- Box begins here -->
    <h2 style="float:left; width:80%">CURAPROX</h2>
    ...
    <table>
    	<thead>
                <tr class="alt">
                    <th><strong> <?php echo "Content"; ?></strong></th>

                    <th>Action</th>
                </tr>
            </thead>
           <tr>
           		<td><?php echo $curaprox['content']?></td>

                 <td><?php Admin::edit($curaprox['id']); ?></td>
           </tr>
    </table><br/><br/><br/>
    <h2 style="float:left; width:80%">Danh sách sản phẩm</h2> <h2 style="float:right; ">  <?php Admin::button('add, delete'); ?> </h2>
     <div style="clear:both"></div>
