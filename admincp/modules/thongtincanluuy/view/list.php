...
<div class="box">
    <h2 style="float:left; width:80%">Danh sách tin tức</h2> <h2 style="float:right; ">  <?php Admin::button('add, delete'); ?> </h2>
        ...
        <table cellspacing="0" cellpadding="0"><!-- Table -->
            ...
            <?php if (empty($rows)) { ?>
                ...
                foreach ($rows as $row) {
                    ...
                    $uri_small = $row['hinh'] != "" ? _path_image . 'notice/small_' . $row['hinh'] : "";
                    $title = $row['title'];
